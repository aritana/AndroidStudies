...
import { Methods } from '../models/route.model';
...
export const RouteSchema = Joi.object({
    ...
    documentation: Joi.string()
        ...
        .required(),
    method: Joi.string()
        .valid(Methods.get, Methods.post, Methods.put, Methods.patch, Methods.delete, Methods.head, Methods.options)
