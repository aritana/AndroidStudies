...
class MockoonServer extends events_1.EventEmitter {
    ...
    start() {
        ...
        if (this.environment.tlsOptions.enabled) {
            try {
                ...
                this.serverInstance = (0, https_1.createServer)(this.tlsOptions, server);
            }
            catch (error) {
            ...
            this.serverInstance = (0, http_1.createServer)(server);
        }
    ...
    serveBody(routeResponse, request, response) {
        try {
            ...
            if (!routeResponse.disableTemplating) {
                body = (0, template_parser_1.TemplateParser)(body || '', request, this.environment);
            }
            response.body = body;
            response.send(body);
        }
    ...
    sendFile(routeResponse, routeContentType, request, response) {
        ...
        try {
            let filePath = (0, template_parser_1.TemplateParser)(routeResponse.filePath.replace(/\\/g, '/'), request, this.environment);
            ...
            if (commons_1.MimeTypesWithTemplating.indexOf(fileMimeType) > -1 &&
                ...
                (0, fs_1.readFile)(filePath, (readError, data) => {
                    ...
                    try {
                        const fileContent = (0, template_parser_1.TemplateParser)(data.toString(), request, this.environment);
    ...
    parseHeader(header, request) {
        ...
        if (header.key && header.value) {
            try {
                parsedHeaderValue = (0, template_parser_1.TemplateParser)(header.value, request, this.environment);
            }
            catch (error) {
    ...
    buildTLSOptions(environment) {
        ...
        if (((_a = environment.tlsOptions) === null || _a === void 0 ? void 0 : _a.pfxPath) ||
            ...
            if (((_d = environment.tlsOptions) === null || _d === void 0 ? void 0 : _d.type) === 'PFX' &&
                ...
                tlsOptions.pfx = (0, fs_1.readFileSync)((0, utils_1.resolvePathFromEnvironment)((_f = environment.tlsOptions) === null || _f === void 0 ? void 0 : _f.pfxPath, this.options.environmentDirectory));
            }
                ...
                tlsOptions.cert = (0, fs_1.readFileSync)((0, utils_1.resolvePathFromEnvironment)((_k = environment.tlsOptions) === null || _k === void 0 ? void 0 : _k.certPath, this.options.environmentDirectory));
                tlsOptions.key = (0, fs_1.readFileSync)((0, utils_1.resolvePathFromEnvironment)((_l = environment.tlsOptions) === null || _l === void 0 ? void 0 : _l.keyPath, this.options.environmentDirectory));
            }
            if ((_m = environment.tlsOptions) === null || _m === void 0 ? void 0 : _m.caPath) {
                tlsOptions.ca = (0, fs_1.readFileSync)((0, utils_1.resolvePathFromEnvironment)((_o = environment.tlsOptions) === null || _o === void 0 ? void 0 : _o.caPath, this.options.environmentDirectory));
            }
