...
exports.Helpers = {
    repeat: function (min, max, options) {
        ...
        if (arguments.length === 3) {
            ...
            count = (0, utils_1.RandomInt)(min, max);
        }
    ...
    int: function (...args) {
        ...
        return faker_1.default.datatype.number(options);
    },
    float: function (...args) {
        const options = {
    ...
    time: function (...args) {
        ...
        if (args.length >= 3 &&
            ...
            return (0, date_fns_1.format)(faker_1.default.date.between(from, to), format || 'HH:mm', {
                useAdditionalWeekYearTokens: true,
                useAdditionalDayOfYearTokens: true
            });
        }
    ...
    hexColor: function () {
        return Math.floor(faker_1.default.datatype.number({ min: 0, max: 1, precision: Math.pow(10, -16) }) *
