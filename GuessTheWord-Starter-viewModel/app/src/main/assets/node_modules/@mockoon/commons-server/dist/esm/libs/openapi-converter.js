...
import { BuildEnvironment, BuildHeader, BuildRoute, BuildRouteResponse, GetRouteResponseContentType, INDENT_SIZE, Methods, RemoveLeadingSlash } from '@mockoon/commons';
/**
...
export class OpenAPIConverter {
    ...
    async convertFromOpenAPI(filePath, port) {
        try {
            ...
            const parsedAPI = await openAPI.dereference.bind(openAPI)(filePath, {
            ...
            paths: environment.routes.reduce((paths, route) => {
                ...
                paths[endpoint][route.method] = {
                    ...
                    responses: route.responses.reduce((responses, routeResponse) => {
                        const responseContentType = GetRouteResponseContentType(environment, routeResponse);
    ...
    convertFromOpenAPIV3(parsedAPI, port) {
        ...
        if ((_a = server === null || server === void 0 ? void 0 : server[0]) === null || _a === void 0 ? void 0 : _a.url) {
            newEnvironment.endpointPrefix = RemoveLeadingSlash(new URL(this.v3ParametersReplace(server[0].url, server[0].variables))
                .pathname);
        }
                ...
                if (routeMethod in Methods) {
                    ...
                    Object.keys(parsedRoute.responses).forEach((responseStatus) => {
                        ...
                        if ((statusCode >= 100 && statusCode <= 999) ||
                            ...
                            routeResponses.push(Object.assign(Object.assign({}, BuildRouteResponse()), { body: schema
                                    ? this.convertJSONSchemaPrimitives(JSON.stringify(this.generateSchema(schema), null, INDENT_SIZE))
                    ...
                    if (!routeResponses.length) {
                        routeResponses.push(Object.assign(Object.assign({}, BuildRouteResponse()), { headers: [BuildHeader('Content-Type', 'application/json')], body: '' }));
                    }
                    const newRoute = Object.assign(Object.assign({}, BuildRoute(false)), { documentation: parsedRoute.summary || parsedRoute.description || '', method: routeMethod, endpoint: RemoveLeadingSlash(this.v2ParametersReplace(routePath)), responses: routeResponses });
