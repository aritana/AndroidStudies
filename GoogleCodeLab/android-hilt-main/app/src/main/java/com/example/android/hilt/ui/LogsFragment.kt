...
/*
    ...
    creates dependencies container that follows the
    Android class lifecycle. And will be able to inject
    instances into LogsFragment.
 */
...
class LogsFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        /*
         Under the hood, Hilt will populate those fields
         in the onAttach() lifecycle
         */
