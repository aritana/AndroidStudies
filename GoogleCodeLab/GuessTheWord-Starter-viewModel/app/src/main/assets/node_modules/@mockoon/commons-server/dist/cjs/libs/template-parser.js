 ...
 * @param request
 */
const TemplateParser = function (content, request, environment) {
    try {
        return (0, handlebars_1.compile)(content)({}, {
            helpers: Object.assign(Object.assign(Object.assign({}, faker_wrapper_1.FakerWrapper), (0, request_helpers_1.RequestHelpers)(request, environment)), helpers_1.Helpers)
        });
    }
    catch (error) {
        throw error;
